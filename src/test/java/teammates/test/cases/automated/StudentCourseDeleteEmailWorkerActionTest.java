...
import teammates.ui.automated.StudentCourseDeleteEmailWorkerAction;

/**
 * SUT: {@link StudentCourseJoinEmailWorkerAction}.
 */
public class StudentCourseDeleteEmailWorkerActionTest extends BaseAutomatedActionTest {
    ...
    public void allTests() {
        ...
        StudentCourseDeleteEmailWorkerAction action = getAction(submissionParams);
        action.execute();
    ...
    @Override
    protected StudentCourseDeleteEmailWorkerAction getAction(String... params) {
        return (StudentCourseDeleteEmailWorkerAction) gaeSimulation.getAutomatedActionObject(getActionUri(), params);
    }
