...
function caculateTotalPages() {
    var a = parseInt(total / entryPerPage, 10);
...
function bindDeleteAccountAction() {
    $('.admin-delete-account-link').on('click', function (event) {
        ...
        var messageText = 'Are you sure you want to delete the account ' + googleId + '?' + ('<br><br>' + existingCourses + '<br><br>This operation will delete ALL information about this account from the system.');
