...
function removeUnwantedVisibilityOptions(commentId) {
    ...
    for (var i = 0; i < checkboxesInInAddForm.length; i += 1) {
...
var addCommentHandler = function addCommentHandler(e) {
    var submitButton = $(e.currentTarget);
    var cancelButton = $(e.currentTarget).next("input[value='Cancel']");
    var formObject = $(e.currentTarget).closest('form');
    var addFormRow = formObject.closest("li[id^='showResponseCommentAddForm']");
    var panelHeading = $(e.currentTarget).parents("[id^='panel_display-']").find('.panel-heading').first();
...
var editCommentHandler = function editCommentHandler(e) {
    var submitButton = $(e.currentTarget);
    var cancelButton = $(e.currentTarget).next("input[value='Cancel']");
    var formObject = $(e.currentTarget).closest('form');
...
var deleteCommentHandler = function deleteCommentHandler(e) {
    var submitButton = $(e.currentTarget);
    e.preventDefault();
